...
// Proses penambahan produk dari halaman index
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['product_id']) && !isset($_POST['add_to_cart']) && !isset($_POST['remove_from_cart']) && !isset($_POST['update_cart'])) {
    ...
    if ($product_id > 0 && $quantity > 0) {
        ...
        if ($stock_data && $quantity <= $stock_data['stock']) {
            ...
            if ($result->num_rows > 0) {
                ...
                if ($new_quantity <= $stock_data['stock']) {
                    ...
                    $_SESSION['cart_message'] = "Jumlah melebihi stok yang tersedia!";
                }
            } else {
            ...
            $_SESSION['cart_message'] = "Stok produk tidak mencukupi!";
        }
    }
